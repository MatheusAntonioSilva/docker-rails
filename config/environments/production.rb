...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "shortner_url_production"
  ...
  config.app.databases.default.host = 'localhost'
  config.app.databases.default.database = 'api_production'
end
